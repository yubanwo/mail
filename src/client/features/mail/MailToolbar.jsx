  ...
  return (
    <header className="relative mb-4 flex items-center justify-between gap-4 overflow-hidden rounded-lg border border-slate-200 bg-white bg-[linear-gradient(to_right,rgba(226,232,240,0.55)_1px,transparent_1px),linear-gradient(to_bottom,rgba(226,232,240,0.45)_1px,transparent_1px)] bg-[size:32px_32px] p-6 shadow-[0_4px_20px_rgba(15,23,42,0.04)] max-[860px]:flex-col max-[860px]:items-stretch max-[860px]:p-5 max-[520px]:mb-3 max-[520px]:gap-3 max-[520px]:p-4">
      <div className="relative z-10">
        ...
        <h1 className="m-0 text-3xl font-black leading-tight text-slate-900 max-[520px]:text-2xl">邮件</h1>
        <p className="mt-2 text-sm font-semibold text-slate-500 max-[520px]:text-xs">{emailCount} 封邮件，按收件人筛选和查看原始内容</p>
      </div>
